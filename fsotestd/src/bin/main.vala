...
{
    var subsystem = new FsoFramework.DBusSubsystem( "fsotest" );
    ...
    if ( count > 0 )
    {
        ...
        FsoFramework.theLogger.info( "fsotestd => mainloop" );
        ...
        mainloop.run();
        FsoFramework.theLogger.info( "mainloop => fsotestd" );
    }
    FsoFramework.theLogger.info( "fsotestd shutdown." );
    return 0;
}
