...
{
    subsystem = new FsoFramework.DBusSubsystem( "fsoevents" );
    ...
    if ( count > 0 )
    {
        ...
        FsoFramework.theLogger.info( "fsoeventsd => mainloop" );
        ...
        */
        ...
        mainloop.run();
        FsoFramework.theLogger.info( "mainloop => fsoeventsd" );
    }
    FsoFramework.theLogger.info( "fsoeventsd exit" );
    return 0;
}
