...
{
    subsystem = new FsoFramework.DBusSubsystem( "fsopreferences" );
    ...
    if ( count > 0 )
    {
        ...
        FsoFramework.theLogger.info( "fsopreferencesd => mainloop" );
        ...
        */
        ...
        mainloop.run();
        FsoFramework.theLogger.info( "mainloop => fsopreferencesd" );
    }
    FsoFramework.theLogger.info( "fsopreferencesd exit" );
    return 0;
}
